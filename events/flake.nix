    ...
    flake-utils.lib.eachDefaultSystem (system:
      ...
      in rec {
        ...
        devShells = rec {
          ...
          pythoneda-shared-code-requests-events-raw-python38 =
          ...
          pythoneda-shared-code-requests-events-raw-python39 =
            shared.raw-devShell-for {
              package = packages.pythoneda-shared-code-requests-events-python39;
              python = pkgs.python39;
              pythoneda-shared-pythoneda-banner =
          ...
          pythoneda-shared-code-requests-events-raw-python310 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-shared-code-requests-events-python310;
              python = pkgs.python310;
          ...
          pythoneda-shared-code-requests-events-raw-python311 =
            shared.raw-devShell-for {
              package =
                packages.pythoneda-shared-code-requests-events-python311;
              python = pkgs.python311;
